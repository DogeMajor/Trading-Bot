...
class KerasModel:
    ...
    def predict(self, ticker):
        ...
        # Split data
        X_train, y_train, X_test, y_test, X_pred = training_and_test_data_pairs(data, self.prediction_size)
...
def training_and_test_data_pairs(data, prediction_size):
    """Return data X, y so that each row in X corresponds to observation value in y. 
    One third test data."""
